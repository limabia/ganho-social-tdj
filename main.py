...
def main(args):
    ...
    populacao = gera_populacao(args.tipoPerfis, args.detalhesPop)
    jogadas(populacao)
...
def arg_parse():
    ...
    parser.add_argument("--tipoPerfis", help="Tipos de perfis", default="")
    parser.add_argument("--detalhesPop", help="Detalhes da população a ser criada", type=int, default=0)
